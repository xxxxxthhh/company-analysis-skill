...
KEY_METRICS = "inventory, gross margin cycle, design wins, customer concentration, node/supply, capex cycle"
...
def analyze(raw_data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "missing_data": [
            "Populate Semiconductors metrics from SEC/company IR/market data connectors",
