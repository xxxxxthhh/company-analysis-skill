"""Metric pack: Fintech / Crypto Infrastructure."""
...
KEY_METRICS = "volume, take rate, AUM/assets, users, regulatory exposure, custody risk"
...
def analyze(raw_data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "missing_data": [
            "Populate Fintech / Crypto Infrastructure metrics from SEC/company IR/market data connectors",
