...
KEY_METRICS = "subscription mix, ecosystem lock-in, renewal base, operating leverage, ROIC, capital return"
...
def analyze(raw_data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "missing_data": [
            "Populate Software / Platform metrics from SEC/company IR/market data connectors",
